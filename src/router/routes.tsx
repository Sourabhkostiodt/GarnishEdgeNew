...
import FeeRule from '../pages/Apps/Rules/FeeRule';
import JsonRun from '../pages/Apps/Calculation/JsonRun';
import ExcelRun from '../pages/Apps/Calculation/ExcelRun';
import FormSelector from '../pages/Apps/Forms/FormSelector';
...
const routes = [
    ...
    {
        path: '/apps/calculation/json-run',
        element: (
            <ProtectedRoute>
                <JsonRun />
            </ProtectedRoute>
    ...
    {
        path: '/apps/calculation/excel-run',
        element: (
            <ProtectedRoute>
                <ExcelRun />
            </ProtectedRoute>
    ...
    {
        path: '/apps/garnishment/employee',
        element: (
            <ProtectedRoute>
                <Employee />
            </ProtectedRoute>
    ...
    {
        path: '/apps/garnishment/iwo-process',
        element: (
            <ProtectedRoute>
                <IWOProcess />
            </ProtectedRoute>
    ...
    {
        path: '/apps/rules/state-tax-levy',
        element: (
            <ProtectedRoute>
                <StateTaxLevy />
            </ProtectedRoute>
    ...
    {
        path: '/apps/rules/creditor-debt',
        element: <CreditorDebt />,
    },
    {
        path: '/apps/rules/fee-rule',
        element: (
            <ProtectedRoute>
                <FeeRule />
            </ProtectedRoute>
