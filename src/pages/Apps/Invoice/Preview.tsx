                            ...
                            {items.map((item) => {
                                return (
                                    <tr key={item.id}>
                                        ...
                                        <td>{item.title}</td>
                                        <td>{item.quantity}</td>
                                        <td className="ltr:text-right rtl:text-left">{getCurrencyConfig().symbol}{item.price}</td>
                                        <td className="ltr:text-right rtl:text-left">{getCurrencyConfig().symbol}{item.amount}</td>
                                    </tr>
                                );
                            })}
                        </tbody>
