...
const Sidebar = () => {
    ...
    const [showUserInterfaceMenu, setShowUserInterfaceMenu] = useState(localStorage.getItem('showUserInterfaceMenu') !== 'false');
    ...
    // Listen for UI menu visibility changes
    useEffect(() => {
        const handleUIMenuVisibilityChange = (event: CustomEvent) => {
            setShowUserInterfaceMenu(event.detail.visible);
        };

        window.addEventListener('uiMenuVisibilityChanged', handleUIMenuVisibilityChange as EventListener);

        return () => {
            window.removeEventListener('uiMenuVisibilityChanged', handleUIMenuVisibilityChange as EventListener);
        };
    }, []);
                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">GarnishEdge</span>
                        </NavLink>
                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    ...
                                    <li className="nav-item">
                                    <NavLink to="/apps/garnishment/order" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                    <NavLink to="/apps/garnishment/iwo-process" className="group mt-1">
                                            <div className="flex items-center">
                                    ...
                                    {/* Rules Section */}
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'rules' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('rules')}>
                                            <div className="flex items-center">
                                                <IconMenuTodo className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Rules</span>
                                            </div>
                                            <div className={currentMenu !== 'rules' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>
                                        <AnimateHeight duration={300} height={currentMenu === 'rules' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <NavLink to="/apps/rules/child-support" className="group">
                                                        <div className="flex items-center">

                                                            <span className="ltr:pl-3 rtl:pr-3">Child Support</span>
                                                        </div>
                                                    </NavLink>
                                                </li>
                                                <li className="relative">
                                                    <NavLink to="/apps/rules/state-tax-levy" className="group">
                                                        <div className="flex items-center">

                                                            <span className="ltr:pl-3 rtl:pr-3">State Tax Levy</span>
                                                        </div>
                                                    </NavLink>
                                                </li>
                                                <li className="relative">
                                                    <NavLink to="/apps/rules/creditor-debt" className="group">
                                                        <div className="flex items-center">

                                                            <span className="ltr:pl-3 rtl:pr-3">Creditor Debt</span>
                                                        </div>
                                                    </NavLink>
                                                </li>
                                                <li className="relative">
                                                    <NavLink to="/apps/rules/fee-rule" className="group">
                                                        <div className="flex items-center">

                                                            <span className="ltr:pl-3 rtl:pr-3">Fee Rule</span>
                                                        </div>
                                                    </NavLink>
                                                </li>
                                            </ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/apps/calculation/json-run" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Json Run')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/calculation/excel-run" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Excel Run')}</span>
                                            </div>
                                        </NavLink>
                                    </li>

                                    {/* Garnishment Forms Section */}
                                    <li className="nav-item">
                                        <NavLink to="/apps/forms/garnishment" className="group">
                                            <div className="flex items-center">
                                                <IconMenuForms className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Garnishment Forms')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                            ...
                            <li className="menu nav-item">
                                <a href="#" target="_blank" className="nav-link group">
                                    <div className="flex items-center">
                            ...
                            <li className="nav-item">
                                ...
                                >
                                    <div className="flex items-center">
                                        <IconLogout className="w-5 h-5 group-hover:!text-primary shrink-0 text-danger" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark group-hover:text-primary">Sign Out</span>
                                    </div>
                                </button>
                            </li>
